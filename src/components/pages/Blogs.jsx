        ...
        <div class="container mx-auto">
            ...
            <div class="w-full px-4">
              <div className="mx-auto mb-12 text-center lg:mb-20">
                ...
                <p className="text-lg text-gray-500">
                  In the ever-evolving world of web development, we share the latest trends and
                  invaluable knowledge to keep you updated.
                </p>
              </div>
            </div>
          </motion.div>
          <div class="-mx-4 flex flex-wrap">
            ...
            >
              <div class="mx-auto mb-10 max-w-[370px]">
                <div class="mb-8 overflow-hidden rounded">
                  <img src={blog1} alt="image" class="w-full" />
                </div>
                <div>
                  ...
                  <p class="text-body-color text-base">
                    Unlocking Online Sales: From Shopping Carts to Checkout Optimization. Tips for
            ...
            >
              <div class="mx-auto mb-10 max-w-[370px]">
                <div class="mb-8 overflow-hidden rounded">
                  <img src={blog2} alt="image" class="w-full" />
                </div>
                <div>
                  <span class="bg-blue-400/80 mb-5 inline-block rounded py-1 px-4 text-center text-xs font-semibold leading-loose text-white">
                    Mar 29, 2023
                  ...
                  <p class="text-body-color text-base">
                    Crafting Engaging User Experiences with Mobile-Friendly Web Designs. Learn the
                    Essentials of Responsiveness.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div class="mx-auto mb-10 max-w-[370px]">
                <div class="mb-8 overflow-hidden rounded">
                  <img src={blog3} alt="image" class="w-full" />
                </div>
                <div>
                  <span class="bg-blue-400/80 mb-5 inline-block rounded py-1 px-4 text-center text-xs font-semibold leading-loose text-white">
                    Jan 10, 2023
                  ...
                  <p class="text-body-color text-base">
                    Boosting Visibility and Ranking on Search Engines. Dive into the World of SEO
                    for Web Development.
                  </p>
                </div>
              </div>
